    ...
    while(true){
        ...
        switch(choice){
            case 1: {
                ...
                cout << YELLOW << "Product selected       : " << product->name << RESET << endl;
            ...
            case 2: {
                ...
                while(true){
                    ...
                    if(cartProduct){
                        ...
                        switch(choice){
                            case 1: removeItemFromCart(cartList, list, id); system("pause"); break;
                            case 2: {
                            ...
                            case 3:system("cls"); cout << YELLOW << "Returning to the previous menu..." << RESET << endl; system("pause"); system("cls");
...
void customerMenu(){
    ...
    while(true){
        ...
        switch(choice){
            ...
            default :cout << RED << "Invalid Input !!! Please Try Again." << RESET << endl; break;
        }
    }
}
